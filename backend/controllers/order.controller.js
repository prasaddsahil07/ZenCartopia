...
export const createOrder = async (req, res) => {
  try {
    ...
    // Create order and associated items within a transaction
 ...
 * Eager load product and seller details.
 */
export const getMyOrders = async (req, res) => {
  try {
    // authMiddleware should attach customer info to req.user
 ...
 * Expects order_id as a URL parameter and new order_status in the body.
 */
